...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/29 12:54:00 by gromero-          #+#    #+#             */
/*   Updated: 2023/07/14 12:25:08 by gromero-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout<<"---------------------> Array Cats and Dogs <-----------------------"<<std::endl;
	{
		...
		for (int i = 0; i < 4; i++)
		{
			std::cout<<"Animal in pos: "<<i<<" is a "<<ptr[3]->getType()<<std::endl;
			ptr[i]->makeSound();
		}
		while (i < 4)
		{
	...
	std::cout<<"---------------------> Last Test <-----------------------"<<std::endl;
	{
		...
		*ptr[3] = *ptr[2];
		...
		std::cout<<"ptr_2 is a "<<ptr_2.getType()<<" from ptr_1"<<std::endl;
